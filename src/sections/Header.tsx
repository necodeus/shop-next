...
export default function HeaderSection() {
	...
	return (
        <header className="font-jost text-[16px] text-mineshaft">
                    ...
                    {navigation.map((link, index) => {
                        return (
                            <Link
                                key={index}
                                href={link.url}
                                className="mt-6 py-6 block w-full text-center"
							>
                                {link.name}
                            </Link>
                        );
                    ...
                    {navigation.map((link, index) => {
                        return (
                            <div key={index} className="relative flex justify-center">
                                ...
                                <Link
                                    href={link.url}
                                    className="outline-none absolute py-6 hover:font-medium focus:font-medium"
								>
                                    {link.name}
                                </Link>
                            </div>
